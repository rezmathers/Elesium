  ...
  return (
    ...
    >
      <div className="relative w-full ">
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto py-3 scroll-smooth [scrollbar-width:none] h-full xs:px-4"
          ref={carouselRef}
          onScroll={checkScrollability}
        >
          <div
            className={cn(
              "absolute right-0  z-[1000] h-12   overflow-hidden bg-gradient-to-l "
            )}
          ></div>
        ...
        <div className="w-full mx-auto flex justify-end gap-2 max-w-7xl mt-4 xs:pr-4 md:pr-0">
          <button
...
export const Card = ({
  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto flex backdrop-blur-2xl">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              ...
              <motion.p
                ...
                className="text-2xl md:text-5xl text-white text-center my-6 font-semibold"
              >
                {card.title}
              </motion.p>
