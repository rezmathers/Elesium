...
<nav className="  fixed w-full z-20 top-0 start-0 border-b  dark:border-gray-600 backdrop-blur-3xl bg-slate-100/5">
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 bg-transparent ">
      <li>
